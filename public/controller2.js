...
.run (function ($rootScope, $http, $cookies, $cookieStore, $location){
  ...
  //if ($rootScope.oid == '' && window.location.href != $rootScope.url+'login.html') window.location.href = $rootScope.url+'login.html';
...
.controller("NavController", function($scope, $rootScope, $http, $cookieStore) {
    $scope.logout = function(user){
        ...
        window.location.href = $rootScope.url+'login.html';
    }
})
